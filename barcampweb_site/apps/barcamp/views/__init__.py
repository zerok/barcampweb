...
create_sideevent = is_organizer(BarcampCreateSideEventView.create_view(), barcamp_slug_kwarg='slug')
edit_sideevent = is_organizer(BarcampEditSideEventView.create_view(), barcamp_slug_kwarg='slug')
delete_sideevent = is_organizer(BarcampDeleteSideEventView.create_view(), barcamp_slug_kwarg='slug')
